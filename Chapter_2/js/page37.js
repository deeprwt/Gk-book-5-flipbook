...
if($('#set37_con1').text().trim() == 'f' | $('#set37_con1').text().trim() == 'F' | $('#set37_con1').text().trim() == 'False' | $('#set37_con1').text().trim() == 'TRUE' | $('#set37_con1').text().trim() == 'true'){$('#set37_con1').css('color','blue');} else{$('#set37_con1').css('color','red');}		
