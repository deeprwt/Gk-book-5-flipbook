$(window).load(function () {
  $(
    "#opt1 .tickboxm,#opt2 .tickboxm,#opt3 .tickboxm,#opt4 .tickboxm,#opt5 .tickboxm,#opt6 .tickboxm"
  ).on("click", tick);
});
...
$(function () {
  ...
  $("#submit02").click(function () {
    for (var i = 1; i <= 9; i++) {
      if (
        $("#opt" + i).find(".tickboxm.t1.coloured.tickbox_blackm").length == 1
      ) {
        $("#opt" + i + " .tickboxm.t1").addClass("tickbox_rightm");
        $("#opt" + i).off("click");
      } else if (
        $("#opt" + i).find(".tickboxm.w1.coloured.tickbox_blackm").length == 1
      ) {
        $("#opt" + i + " .tickboxm.w1").addClass("tickbox_wrongm");
      } else if (
        $("#opt" + i).find(".tickboxm.w2.coloured.tickbox_blackm").length == 1
      ) {
        $("#opt" + i + " .tickboxm.w2").addClass("tickbox_wrongm");
      } else if (
        $("#opt" + i).find(".tickboxm.w3.coloured.tickbox_blackm").length == 1
      ) {
        $("#opt" + i + " .tickboxm.w3").addClass("tickbox_wrongm");
      }

    //   if (
    //     ($("#input01").text().trim() == "KOAN") |
    //     ($("#input01").text().trim() == "koan")
    //   ) {
    //     $("#input01").css("color", "blue");
    //   } else {
    //     $("#input01").css("color", "red");
    //   }
    //   if (
    //     ($("#input02").text().trim() == "ROAM") |
    //     ($("#input02").text().trim() == "roam")
    //   ) {
    //     $("#input02").css("color", "blue");
    //   } else {
    //     $("#input02").css("color", "red");
    //   }
    }

    if (
      $("#opt1").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1 &&
      $("#opt2").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1 &&
      $("#opt3").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1 &&
      $("#opt4").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1 &&
      $("#opt5").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1 &&
      $("#opt6").find(".tickboxm.t1.coloured.tickbox_blackm").length == 1
    ) {
  ...
  $("#submit05").click(function () {
    if (
      ($("#set09_con1").text().trim() == "f") |
      ($("#set09_con1").text().trim() == "F") |
      ($("#set09_con1").text().trim() == "False") |
      ($("#set09_con1").text().trim() == "FALSE") |
      ($("#set09_con1").text().trim() == "false")
    ) {
      $("#set09_con1").css("color", "blue");
    } else {
      $("#set09_con1").css("color", "red");
    }
    if (
      ($("#set09_con2").text().trim() == "f") |
      ($("#set09_con2").text().trim() == "F") |
      ($("#set09_con2").text().trim() == "False") |
      ($("#set09_con2").text().trim() == "FALSE") |
      ($("#set09_con2").text().trim() == "false")
    ) {
      $("#set09_con2").css("color", "blue");
    } else {
      $("#set09_con2").css("color", "red");
    }
    if (
      ($("#set09_con3").text().trim() == "t") |
      ($("#set09_con3").text().trim() == "T") |
      ($("#set09_con3").text().trim() == "True") |
      ($("#set09_con3").text().trim() == "TRUE") |
      ($("#set09_con3").text().trim() == "true")
    ) {
      $("#set09_con3").css("color", "blue");
    } else {
      $("#set09_con3").css("color", "red");
    }
    if (
      ($("#set09_con4").text().trim() == "t") |
      ($("#set09_con4").text().trim() == "T") |
      ($("#set09_con4").text().trim() == "True") |
      ($("#set09_con4").text().trim() == "TRUE") |
      ($("#set09_con4").text().trim() == "true")
    ) {
      $("#set09_con4").css("color", "blue");
    } else {
      $("#set09_con4").css("color", "red");
    }
