...
$('#submit01').bind('touchstart click',function(e){
		...
		$('#page18_con2').text('three-toed sloth');
...
if($('#page18_con2').text().trim() == 'THREE-TOED SLOTH' | $('#page18_con2').text().trim() == 'three-toed sloth' | $('#page18_con2').text().trim() == 'three-toed sloth'){$('#page18_con2').css('color','blue');} else{$('#page18_con2').css('color','red');}
