...
if($('#set55_con4').text().trim() == "Gulliver's Travels" | $('#set55_con4').text().trim() == "Gulliver's Travels" | $('#set55_con4').text().trim() == "Gulliver's Travels"){$('#set55_con4').css('color','blue');} else{$('#set55_con4').css('color','red');}
...
if(($('#set55_con1').text().trim() == 'harry potter' | $('#set55_con1').text().trim() == 'Harry Potter' | $('#set55_con1').text().trim() == 'HARRY POTTER') && ($('#set55_con2').text().trim() == 'Adventures Of Tom Sawyer' | $('#set55_con2').text().trim() == 'adventures of tom sawyer' | $('#set55_con2').text().trim() == 'Adventures of Tom Sawyer' | $('#set55_con2').text().trim() == 'ADVENTURES OF TOM SAWYER') && ($('#set55_con3').text().trim() == 'jungle book' | $('#set55_con3').text().trim() == 'Jungle Book' | $('#set55_con3').text().trim() == 'JUNGLE BOOK') && ($('#set55_con4').text().trim() == "Gulliver's Travels" | $('#set55_con4').text().trim() == "Gulliver's Travels" | $('#set55_con4').text().trim() == "Gulliver's Travel's") && ($('#set55_con5').text().trim() == 'treasure island' | $('#set55_con5').text().trim() == 'Treasure Island' | $('#set55_con5').text().trim() == 'TREASURE ISLAND') && ($('#set55_con6').text().trim() == '101 dalmatians' | $('#set55_con6').text().trim() == '101 Dalmatians' | $('#set55_con6').text().trim() == '101 DALMATIANS') && ($('#set55_con7').text().trim() == 'shrek' | $('#set55_con7').text().trim() == 'Shrek' | $('#set55_con7').text().trim() == 'SHREK'))
			{
