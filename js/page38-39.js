...
$('#a_idContainer161').bind('touchstart click',function(e){
for_popup1_v('pops6','pbutton6','video6');
});

$('#a_idContainer170').bind('touchstart click',function(e){
for_popup1_v('pops7','pbutton7','video7');
});

$('#a_idContainer164').bind('touchstart click',function(e){
for_popup1_v('pops8','pbutton8','video8');
});

$('#a_idContainer173').bind('touchstart click',function(e){
for_popup1_v('pops9','pbutton9','video9');
});


$('#a_idContainer176').bind('touchstart click',function(e){
for_popup1_v('pops11','pbutton11','video11');
});

$('#a_idContainer185').bind('touchstart click',function(e){
for_popup1_v('pops12','pbutton12','video12');
});


$('#a_idContainer186').bind('touchstart click',function(e){
for_popup1_v('pops13','pbutton13','video13');
});



$('#submit011').bind('touchstart click',function(e){
