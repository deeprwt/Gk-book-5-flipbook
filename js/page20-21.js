...
video_audio('pops18','video18','audio');
});
$('#video18').on('play',function(e){
	videoon('audio','video18');
});
$('#video18').on('pause',function(e){
	videooff('audio','video18');
});
$('#audio').on('pause',function(e){
e.preventDefault();	
	audiooff('audio','video18');
});
dragdrop('box1','text1');
dragdrop('box2','text2');
dragdrop('box3','text3');
...
$('#submit08').bind('touchstart click',function(e){
