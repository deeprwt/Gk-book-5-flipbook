...
var urlList1 = [
  { key: "Cover", url: "Chapter_1/index.html" },
  { key: "Chapter_1", url: "Chapter_2/index.html" },
  { key: "Chapter_2", url: "Chapter_3/index.html" },
  { key: "Chapter_3", url: "Chapter_4/index.html" },
  { key: "Chapter_4", url: "Chapter_5/index.html" },
  { key: "Chapter_5", url: "Chapter_6/index.html" },
  { key: "Chapter_6", url: "Chapter_7/index.html" },
  { key: "Chapter_7", url: "Chapter_8/index.html" },
  { key: "Chapter_8", url: "Chapter_9/index.html" },
  { key: "Chapter_9", url: "Chapter_10/index.html" },
  { key: "Chapter_10", url: "Chapter_11/index.html" },
  { key: "Chapter_11", url: "Chapter_12/index.html" },
  { key: "Chapter_12", url: "Chapter_13/index.html" },
  { key: "Chapter_13", url: "Chapter_14/index.html" },
  { key: "Chapter_14", url: "Chapter_15/index.html" },
  { key: "Chapter_15", url: "Chapter_16/index.html" },
  { key: "Chapter_16", url: "Chapter_17/index.html" },
  { key: "Chapter_17", url: "Chapter_18/index.html" },
  { key: "Chapter_18", url: "Activity/index.html" },
  { key: "Activity", url: "Chapter_19/index.html" },
  { key: "Chapter_19", url: "Testpaper/index.html" },
];
//var urlList1 = [];
var urlList2 = [
  { key: "Chapter_1", url: "Cover/index.html#page3" },
  { key: "Chapter_2", url: "Chapter_1/index.html" },
  { key: "Chapter_3", url: "Chapter_2/index.html" },
  { key: "Chapter_4", url: "Chapter_3/index.html#page1" },
  { key: "Chapter_5", url: "Chapter_4/index.html#page1" },
  { key: "Chapter_6", url: "Chapter_5/index.html#page1" },
  { key: "Chapter_7", url: "Chapter_6/index.html#page1" },
  { key: "Chapter_8", url: "Chapter_7/index.html#page1" },
  { key: "Chapter_9", url: "Chapter_8/index.html" },
  { key: "Chapter_10", url: "Chapter_9/index.html#page1" },
  { key: "Chapter_11", url: "Chapter_10/index.html#page1" },
  { key: "Chapter_12", url: "Chapter_11/index.html" },
  { key: "Chapter_13", url: "Chapter_12/index.html" },
  { key: "Chapter_14", url: "Chapter_13/index.html#page1" },
  { key: "Chapter_15", url: "Chapter_14/index.html#page1" },
  { key: "Chapter_16", url: "Chapter_15/index.html#page1" },
  { key: "Chapter_17", url: "Chapter_16/index.html#page1" },
  { key: "Chapter_18", url: "Chapter_17/index.html#page1" },
  { key: "Activity", url: "Chapter_18/index.html#page1" },
  { key: "Chapter_19", url: "Activity/index.html" },
  { key: "Testpaper", url: "Chapter_19/index.html#page1" },
];
//var urlList2 = [];
var CoverPageFolderName = "Cover";
var LastPageFolderName = "Testpaper";
...
function ChangePageViewMode() {
  ...
  if (noOfPage == 2) {
    ...
    if ($("#" + MainPageID + " .second").length != null) {
      ...
      $("#" + MainPageID + " .second .secondsub").css(
        "-webkit-transform",
        "translate(612.00px,0.00px)"
      );
      $("#" + MainPageID + " .second .secondsub").css(
        "-ms-transform",
        "translate(612.00px,0.00px)"
...
function PageNavigation(nextorpre) {
  ...
  if (
    FirstPageID == MainPageID &&
    firsttimepageswitch == false &&
    FindFolderName() == CoverPageFolderName
  ) {
...
function mousedownOnContainer(e) {
  ...
  if (highlight && markedpage != 0) {
    ...
    $("#" + node.id).append(
      "<img src='../img/closegrey.png' class='rmv-highlight' onclick='RemoveHighlighter(" +
        node.id +
        ")' />"
    );
  }
...
function checkbrowser() {
  var ExpiryDate = new Date("June 15, 2023 00:00:00");
...
function printDiv(divName) {
  ...
  if (noOfPage == 2) {
    $(".grid_10").css("width", "50%");
    $(".fullscreen1 .book-wrapper").css("height", "1790px");

    $("#" + MainPageID + " .bb-custom-side").css("width", "100%");
    $("#" + MainPageID + " .bb-custom-side").css("height", "50%");
  ...
  function innerHighlight(node, pat) {
    ...
    if (node.nodeType == 3) {
      ...
      if (pos >= 0) {
        ...
        if (
          middlebit.parentNode.id != null &&
          middlebit.parentNode.id != undefined &&
          middlebit.parentNode.id != ""
        ) {
          if ($("#" + middlebit.parentNode.id).css("display") == "none") {
            Visiblemark = "hidden";
          }
        } else {
          if (
            middlebit.parentNode.parentNode.id != null &&
            middlebit.parentNode.parentNode.id != undefined &&
            middlebit.parentNode.parentNode.id != ""
          ) {
            if (
              $("#" + middlebit.parentNode.parentNode.id + " p").css(
                "display"
              ) == "none" ||
              $("#" + middlebit.parentNode.parentNode.id + " span").css(
                "display"
              ) == "none"
            ) {
              Visiblemark = "hidden";
...
jQuery.fn.removeHighlight = function () {
  ...
  return this.find("span.highlightsearch")
    .each(function () {
