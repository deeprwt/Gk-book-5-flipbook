        ...
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				var line_height = ($(ui.draggable).text().length <= 22)? "25px" : "15px";
				
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "129px", "line-height": line_height, "height": "27px"}, 200, "linear");
				var _this = this;
				setTimeout(function(){
...
function dragdrop_transformm(box,text)
{	
    $('#'+box).droppable({
        accept: "#"+text,
        tolerance: 'touch',
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				var line_height = ($(ui.draggable).text().length <= 22)? "27px" : "15px";
				
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "100", "line-height": line_height, "height": "25px"}, 100, "linear");
				var _this = this;
				setTimeout(function(){
					$(_this).css({"white-space": "unset", "text-align": "center"});
					console.log(_this);
        ...
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				var line_height = ($(ui.draggable).text().length <= 15)? "20px" : "15px";
				
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "auto", "line-height": line_height, "height": "20px"}, 200, "linear");
				var _this = this;
				setTimeout(function(){
					$(_this).css({"white-space": "unset", "text-align": "center"});
					console.log(_this);
...
function dragdrop_left(box,text)
{	
    $('#'+box).droppable({
        accept: "#"+text,
        tolerance: 'touch',
...
function dragdrop_page42(box,text)
{	
    $('#'+box).droppable({
        accept: "#"+text,
        tolerance: 'touch',
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				var leftDropBox = parseInt($(event.target).css('left'));
				$(ui.draggable).css({transform: transformDropBox});
				var line_height = ($(ui.draggable).text().length <= 20)? "15px" : "22px";
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "87", "line-height": "18px", "height": "22px"}, 200, "linear");
				var _this = this;
				setTimeout(function(){
					$(_this).css({"white-space": "unset", "text-align": "center", "font-size": "11px"});
					console.log(_this);
				}, 200);
				console.log("top: ", topDropBox, ", left: ", leftDropBox);
			  }
...
function dragdrop_page42a(box,text)
{	
    $('#'+box).droppable({
        accept: "#"+text,
        tolerance: 'touch',
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				$(ui.draggable).css({transform: transformDropBox});
				var line_height = ($(ui.draggable).text().length <= 20)? "15px" : "22px";
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "124", "line-height": "18px", "height": "22px"}, 200, "linear");
				var _this = this;
				setTimeout(function(){
					$(_this).css({"white-space": "unset", "text-align": "center", "font-size": "11px"});
					console.log(_this);
...
function dragdrop_transform_page51(box,text)
{	
    $('#'+box).droppable({
        accept: "#"+text,
        tolerance: 'touch',
        drop: function(event, ui) {
			...
			ui.draggable.position({
			  ...
			  using: function(pos) {
				...
				$(this).animate({"top": topDropBox, "left": leftDropBox, "width": "113px", "line-height": line_height, "height": "22px"}, 200, "linear");
				var _this = this;
				setTimeout(function(){
					$(_this).css({"white-space": "unset", "text-align": "center"});
					console.log(_this);
